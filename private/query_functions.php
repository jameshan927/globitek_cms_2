<?php
  ...
  function validate_state($state, $errors=array()) {
	...
	$errors = valid_state_code($state['code'], $errors);
	$errors = valid_state_country_id($state['country_id'], $errors);
	$errors = valid_state_name($state['name'], $errors);
  ...
  function validate_territory($territory, $errors=array()) {
	...
	$errors = valid_territory_name($territory['name'], $errors);
	$errors = valid_territory_position($territory['position'], $errors);
    return $errors;
  }
  ...
  function validate_salesperson($salesperson, $errors=array()) {
	...
	$errors = valid_first_name($salesperson['first_name'], $errors);
	$errors = valid_last_name($salesperson['last_name'], $errors);
	$errors = valid_phone($salesperson['phone'], $errors);
	$errors = valid_email($salesperson['email'], $errors);
